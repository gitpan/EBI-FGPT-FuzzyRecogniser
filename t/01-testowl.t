...
my $fuzzy = EBI::FGPT::FuzzyRecogniser->new( owlfile => $fh->filename );    # create an object
...
use Data::Dumper;
print Dumper( $fuzzy->find_match("adenocarcinoma") );
print Dumper( $fuzzy->find_match("ademfgocarcinoma") );
